...
const programsData = {
  btech: {
    ...
    duration: "4 Years",
    description:
      "NIT Raipur offers Bachelor of Technology (B.Tech) programs across 12 engineering and technology disciplines. These programs are designed to develop strong technical foundations, problem-solving abilities, and industry-ready skills in students.",
    icon: Cpu,
    branches: [
      {
        ...
        seats: 114,
        vision:
          "To produce ethically strong, highly competent professionals in Computer Science and Engineering for serving the society.",
        mission:
          "To impart quality education, promote research and innovation, and develop leadership qualities through a robust curriculum.",
        description:
          "Focuses on software development, algorithms, data structures, AI, machine learning, and computer networks.",
      ...
      },
      {
        ...
        seats: 114,
        vision:
          "To be a leader in providing quality education and research in the field of Electronics and Communication Engineering.",
        mission:
          "To create an environment for students to acquire technical skills and research capabilities to solve global challenges.",
        description:
          "Covers analog and digital electronics, communication systems, signal processing, VLSI design, and embedded systems.",
      ...
      },
      {
        ...
        seats: 115,
        vision:
          "To produce globally competent electrical engineers capable of adapting to the changing needs of industry and society.",
        mission: "To provide quality education in Electrical Engineering with emphasis on professional ethics and research.",
        description:
          "Covers power systems, electrical machines, control systems, power electronics, and renewable energy technologies.",
      ...
      },
      {
        ...
        seats: 115,
        vision:
          "To be recognized as a center of excellence in Mechanical Engineering education and research.",
        mission:
          "To provide state-of-the-art education and research environment in Mechanical Engineering and allied areas.",
        description:
          "Focuses on thermodynamics, fluid mechanics, manufacturing processes, machine design, and automobile engineering.",
      ...
      },
      {
        ...
        seats: 97,
        vision:
          "To produce civil engineers of international standard who can contribute to infrastructure development.",
        mission:
          "To promote excellence in civil engineering education and research through collaborative learning.",
        description:
          "Covers structural engineering, geotechnical engineering, transportation, water resources, and environmental engineering.",
      ...
      },
      {
        ...
        description:
          "Covers chemical process engineering, reaction engineering, process control, and environmental engineering.",
      ...
      },
      {
        ...
        description:
          "Focuses on material science, extractive metallurgy, physical metallurgy, and advanced materials.",
      ...
      },
      {
        ...
        seats: 97,
        vision:
          "To be a leading department for providing skilled mining engineers for sustainable mineral development.",
        mission:
          "To provide high-quality education and conduct research in mining and allied areas.",
        description:
          "Covers mine planning, rock mechanics, mineral processing, and mine safety.",
      ...
      },
      {
        ...
        mission:
          "To develop skilled professionals capable of designing advanced medical instrumentation.",
        description:
          "Combines engineering with medical sciences covering medical imaging, biomechanics, and clinical engineering.",
      ...
      },
      {
        ...
        description:
          "Focuses on software engineering, web technologies, information security, and cloud computing.",
      ...
      },
      {
        ...
        seats: 79,
        vision:
          "To be a sound center for education and research in field of Biotechnology in India.",
        mission:
          "To provide adequate and scientific education in Biotechnology and prepare students for innovative careers.",
        description:
          "Covers genetic engineering, bioprocess technology, molecular biology, and bioinformatics.",
      ...
      },
      {
        ...
        seats: 40,
        vision:
          "To create professionals with a sensitivity toward the environment and architectural aesthetics.",
        mission:
          "To promote excellence in architecture and planning through a blend of tradition and modernity.",
        description:
          "The B.Arch program develops skills in architectural design and urban planning over a 5-year duration.",
        highlights: ["Architectural Design", "Building Construction", "Urban Planning", "Sustainable Architecture"]
      }
    ]
  },

  /* ------ Remaining programs unchanged (mtech, msc, phd, mba, mca) ------ */

  mtech: {
    title: "M.Tech Programs",
    duration: "2 Years",
    description:
      "Master of Technology (M.Tech) programs provide advanced specialization in various engineering and geoscience disciplines.",
    icon: BookOpen,
    branches: [
      {
        ...
        seats: 19,
        vision:
          "To promote the sustainable development and conservation of mineral and natural resources.",
        mission:
          "To promote Human Resource Development in achieving goals of sustainable development and conservation of natural resources.",
        description:
          "Specialized study in structural geology, mineralogy, and mineral exploration.",
  ...
  msc: {
    ...
    duration: "2 Years",
    description:
      "Master of Science programs offer advanced theoretical knowledge and research in fundamental and applied sciences.",
    icon: FlaskConical,
    branches: [
      {
        name: "Physics",
        ...
        seats: 20,
        vision:
          "To provide quality scientific and technical education, training, innovation and creativity in Pure and Applied Physics.",
        mission:
          "To contribute towards the country through excellence in scientific education and research.",
        description:
          "Advanced study in quantum mechanics, solid state physics, and nuclear physics.",
      ...
      },
      {
        ...
        seats: 20,
        vision:
          "To provide a platform of nationally recognized model of education to compete in a technology-centered world.",
        mission:
          "To nurture students by providing quality education in classroom teaching, laboratories, and research.",
        description:
      ...
      },
      {
        ...
        seats: 20,
        vision:
          "To emerge as a center of excellence in mathematical sciences and its applications.",
        mission:
          "To promote excellence in mathematical education and research.",
        description:
          "Study of pure and applied mathematics including algebra and numerical methods.",
  ...
  phd: {
    ...
    duration: "3-5 Years",
    description:
      "Doctoral programs are offered across Engineering, Science, Management, and Humanities departments.",
    icon: GraduationCap,
    branches: [
      {
        ...
        vision:
          "To render world class professionals efficient in communicative, managerial and entrepreneurial skills.",
        mission:
          "To develop an immersive learning and innovative environment and state-of-art interdisciplinary research.",
        description:
          "Research in English literature, Linguistics, Sociology, and Management.",
      ...
      },
      {
        ...
        seats: "Variable",
        vision: "To promote innovation and high-quality research in engineering.",
        mission: "To produce researchers who can solve technical problems of society.",
        description: "Ph.D opportunities in all major engineering branches.",
        highlights: ["Research", "Patents"]
      }
    ]
  },
  ...
  mba: {
    ...
    duration: "2 Years",
    description:
      "The MBA program integrates technical expertise with managerial decision-making skills.",
    icon: Briefcase,
    branches: [
      {
        ...
        vision:
          "To render world class professionals efficient in communicative, managerial and entrepreneurial skills.",
        mission:
          "To inculcate higher order decision making skills through a broad spectrum of learning content.",
  ...
  mca: {
    ...
    duration: "2 Years",
    description:
      "The Master of Computer Applications program focuses on high-level software development and IT management.",
    icon: Monitor,
    branches: [
      {
        ...
        seats: 110,
        vision:
          "To provide best possible education that would help in developing students with strong technical backgrounds.",
        mission:
          "To impart quality education to meet the needs of professional societies and the nation.",
        description:
          "Covers data structures, cloud computing, AI/ML, and network security.",
